...
adf_run_id = getArgument("adf_run_id")  # noqa: F821
...
training_mount_point_name = "/dbfs" + getArgument("training_mount_point_name") + "/" + adf_run_id  # noqa: F821, E501
testing_mount_point_name = "/dbfs" + getArgument("testing_mount_point_name") + "/" + adf_run_id  # noqa: F821, E501
training_dir_name = getArgument("training_mount_point_name") + "/" + adf_run_id  # noqa: F821, E501
testing_dir_name = getArgument("testing_mount_point_name") + "/" + adf_run_id  # noqa: F821, E501
...
# Create folder in output containers corresponding to the current adf run id
dbutils.fs.mkdirs(training_dir_name)  # noqa: F821
dbutils.fs.mkdirs(testing_dir_name)  # noqa: F821
